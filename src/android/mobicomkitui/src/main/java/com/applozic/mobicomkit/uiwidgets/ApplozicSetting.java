...
public class ApplozicSetting {
    ...
    private static final String SHOW_DOWNLOAD_ATTACHMENT_IN_CONTEXT_MENU = "SHOW_DOWNLOAD_ATTACHMENT_IN_CONTEXT_MENU";
    ...
    public ApplozicSetting showDownloadOptionInContextMenu(Boolean showOption) {
        sharedPreferences.edit().putBoolean(SHOW_DOWNLOAD_ATTACHMENT_IN_CONTEXT_MENU, showOption).commit();
        return this;
    }

    public boolean isDownloadOptionEnbledInContextMenu() {
        return sharedPreferences.getBoolean(SHOW_DOWNLOAD_ATTACHMENT_IN_CONTEXT_MENU, false);
    }

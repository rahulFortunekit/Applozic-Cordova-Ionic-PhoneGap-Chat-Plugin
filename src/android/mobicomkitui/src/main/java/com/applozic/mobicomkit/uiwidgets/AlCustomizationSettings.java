...
public class AlCustomizationSettings extends JsonMarker {
    ...
    private boolean showDownloadOptionInContextMenu = false;
    ...
    public boolean showDownloadOptionInContextMenu() {
        return showDownloadOptionInContextMenu;
    }

    public void enableDownloadOptionInContextMenu(boolean enableDownloadOption) {
        this.showDownloadOptionInContextMenu = enableDownloadOption;
    }
